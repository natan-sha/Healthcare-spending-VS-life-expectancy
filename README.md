...
2. Fetch country metadata to get income group classification and filter out regional aggregates (e.g. "World", "Europe & Central Asia")
3. Merge datasets on countryiso3code + date
